...
public class ItemCrop extends ModItem {
    ...
    public boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ) {
        if (!world.isRemote) {
            if (world.getBlock(x, y, z)==net.minecraft.init.Blocks.farmland && (world.getBlock(x, y + 1, z)==net.minecraft.init.Blocks.air || world.getBlock(x, y + 1, z)instanceof BlockHidden) && side == 1) {
