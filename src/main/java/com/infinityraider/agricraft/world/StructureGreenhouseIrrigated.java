...
public class StructureGreenhouseIrrigated extends StructureGreenhouse {
    ...
    public boolean addComponentParts(World world, Random rand, StructureBoundingBox boundingBox) {
        ...
        this.fillWithBlocks(world, boundingBox, 5, 5, 5, 5, 5, 10, com.infinityraider.agricraft.init.AgriBlocks.blockWaterChannel.getDefaultState(), com.infinityraider.agricraft.init.AgriBlocks.blockWaterChannel.getDefaultState(), false);
        for(int z=5;z<=10;z++) {
            this.generateStructureIrrigationChannel(world, boundingBox, 5, 5, z);
        }
        this.fillWithBlocks(world, boundingBox, 6, 5, 10, 11, 5, 10, com.infinityraider.agricraft.init.AgriBlocks.blockWaterChannel.getDefaultState(), com.infinityraider.agricraft.init.AgriBlocks.blockWaterChannel.getDefaultState(), false);
        for(int x=6;x<=11;x++) {
    ...
    protected boolean generateStructureWoodenTank(World world, StructureBoundingBox boundingBox, int x, int y, int z, boolean multiBlockify) {
        ...
        if (boundingBox.isVecInside(new Vec3i(xCoord, yCoord, zCoord))) {
            ...
            world.setBlockState(pos, com.infinityraider.agricraft.init.AgriBlocks.blockWaterTank.getDefaultState(), 2);
    ...
    protected boolean generateStructureIrrigationChannel(World world, StructureBoundingBox boundingBox, int x, int y, int z) {
        ...
        if (boundingBox.isVecInside(new Vec3i(xCoord, yCoord, zCoord))) {
            BlockPos pos = new BlockPos(xCoord, yCoord, zCoord);
            world.setBlockState(pos, com.infinityraider.agricraft.init.AgriBlocks.blockWaterChannel.getDefaultState(), 2);
    ...
    protected boolean generateStructureSprinkler(World world, StructureBoundingBox boundingBox, int x, int y, int z) {
        ...
        if (boundingBox.isVecInside(new Vec3i(xCoord, yCoord, zCoord))) {
            BlockPos pos = new BlockPos(xCoord, yCoord, zCoord);
            world.setBlockState(pos, com.infinityraider.agricraft.init.AgriBlocks.blockSprinkler.getDefaultState(), 2);
            return true;
        }
        else {
            return false;
