...
public class JadePlugin implements IAgriPlugin, IWailaPlugin {
    ...
    public void register(IRegistrar registrar) {
        ...
        registrar.registerIconProvider(cropProvider, BlockCropPlant.class);
        registrar.registerComponentProvider(cropProvider, TooltipPosition.HEAD, BlockCropPlant.class);
