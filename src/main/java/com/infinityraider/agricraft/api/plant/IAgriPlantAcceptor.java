...
public interface IAgriPlantAcceptor {
    ...
    /**
     * Sets the AgriPlant associated with this instance. Should always return the
     * same result as acceptsPlant() if the plant is invalid.
     *
     ...
     *
     * @return the removed plant, or null if no plant was removed.
     */
