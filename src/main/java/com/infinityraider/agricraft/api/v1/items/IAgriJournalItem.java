...
/**
 * This interface is implemented in AgriCraft's agricultural item class for the
 * journal. Can be used to extract/add information from the journal.
 *
 * e.g. ((IJournal) stack.getItem()).isSeedDiscovered(stack, someSeed);
 *
 * If, for some reason you do not wish to interact with this interface, you can
 * also use methods provided by APIv2
 */
