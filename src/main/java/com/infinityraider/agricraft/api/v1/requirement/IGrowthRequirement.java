...
/**
 * Interface representing the set of conditions, soils, and light levels
 * required for a given plant to grow.
 * <p>
 * This interface will likely be internalized in a future release, favoring
 * instead the sole usage of the modular {@link IConditions} (and possibly a set
 * of valid soils). This transition is largely due to the requisite
 * functionality of the {@link #hasValidConditions(world, pos) not being achievable in a default method.
 * <p>
 * The preferred method to use this interface is to read or set data to existing
...
public interface IGrowthRequirement {
    ...
    /**
     * Retrieves a list of all the soils that are valid for this growth
     * requirement.
     *
    ...
    /**
     * Retrieves a list of all the conditions that make up this growth
     * requirement.
     *
    ...
    /**
     * Determines the minimum (inclusive) light level at which the plant can
     * grow.
     *
    ...
    /**
     * Determines the maximum (inclusive) light level at which the plant can
     * grow.
     *
    ...
    /**
     * Determines if the given location in the given world has a valid soil
     * directly beneath it.
     *
     ...
     * of this growth requirement as defined by {@link #getConditions()}.
     * <p>
     * <em>This method does not check the light level! Use
     ...
     * falls within the range defined by {@link #getMinLight()} (inclusive) and
     * {@link #getMaxLight()} (inclusive).
     *
     * @param world The world in which to test the light level.
     * @param pos The position in the given world at which to test the light
     * level.
     ...
     * given world.
     * <p>
     * The growth requirement is met <i>if-and-only-if</i> the following
     * sequence of methods all evaluate to true:
     * <ol>
     ...
     * @param pos The position in the given world at which to test this growth
     * requirement at.
     ...
     * the JEI interface.
     * <p>
     * In the future this method will be removed, in the expectation that all
     * conditions should be represented in the JEI menu. However, for now, this
     * method should only be called internally by the AgriCraft JEI interface.
     *
