...
public class AgriCraftItemModel implements IModel {
	...
	public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
		...
		if (!textures.isEmpty()) {
			builder.addAll(ItemLayerModel.getQuadsForSprite(0, base, format, Optional.fromNullable(transform)));
		...
		return new AgriCraftBakedItemModel(builder.build(), base, false);
