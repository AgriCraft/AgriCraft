...
public interface Reference {
    ...
    String VER_PATCH = /*^${mod.version_patch}^*/ "3";
    String MOD_VERSION = /*^${mod.version}^*/ "3.0.3";
    String VERSION = /*^${mod.version_minecraft}-${mod.version}^*/ "1.16.4-3.0.3";

    String VERSION_INFLIB = /*^${mod.version_inflib}^*/ "1.16.4-2.0.0";
