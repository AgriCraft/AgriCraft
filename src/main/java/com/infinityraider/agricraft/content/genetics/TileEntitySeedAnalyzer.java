package com.infinityraider.agricraft.content.genetics;
...
public class TileEntitySeedAnalyzer extends TileEntityRotatableBase implements ISidedInventory, ITickable, IAgriDisplayable, IInventoryItemHandler {
    ...
    protected void writeRotatableTileNBT(NBTTagCompound tag) {
        ...
        if (!this.journal.isEmpty() && this.journal.getItem() != null) {
            ...
            tag.setTag(AgriItemRegistry.getInstance().journal.getUnlocalizedName(), journalTag);
        }
    ...
    protected void readRotatableTileNBT(NBTTagCompound tag) {
        ...
        if (tag.hasKey(AgriItemRegistry.getInstance().journal.getUnlocalizedName())) {
            this.journal = new ItemStack(tag.getCompoundTag(AgriItemRegistry.getInstance().journal.getUnlocalizedName()));
        } else {
