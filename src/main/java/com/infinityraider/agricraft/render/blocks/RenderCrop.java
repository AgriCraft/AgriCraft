...
public class RenderCrop extends RenderBlockWithTileBase<BlockCrop, TileEntityCropSticks> {
    ...
    public RenderCrop(BlockCrop block) {
        super(block, new TileEntityCropSticks(), false, true, false);
    ...
    public void renderWorldBlockDynamic(ITessellator tessellator, World world, BlockPos pos, double x, double y, double z,
                                        BlockCrop block, TileEntityCropSticks crop, float partialTick, int destroyStage, float alpha) {
    }
    ...
    @Override
    public void renderInventoryBlock(ITessellator tessellator, World world, IBlockState state, BlockCrop block, TileEntityCropSticks tile,
