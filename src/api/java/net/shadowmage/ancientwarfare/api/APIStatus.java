...
public enum APIStatus {
     ...
     *
     * - You called getAPI() before Ancient Warfare was initialized. Don't call
     * getAPI() in the PREINIT phase.
     *
     * - Someone included the API with their mod, Ancient Warfare is not actually
     * installed.
     */
    API_NOT_INITIALIZED,
    /**
     ...
     * The API was properly loaded and your API object is ready to go.
     *
     * The Ancient Warfare that returned your API object supports a newer version than
