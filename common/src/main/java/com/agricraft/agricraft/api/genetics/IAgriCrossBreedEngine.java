...
public interface IAgriCrossBreedEngine {
	 ...
	 * @return this
	 */
	IAgriCrossBreedEngine setSelectionLogic(@NotNull IParentSelector selector);
	 ...
	 * @return this
	 */
	IAgriCrossBreedEngine setCloneLogic(@NotNull ICloneLogic cloneLogic);
	 ...
	 * @return this
	 */
	IAgriCrossBreedEngine setCombineLogic(@NotNull ICombineLogic combineLogic);
	...
	interface IParentSelector {
		 ...
		 */
		@NotNull
		List<IAgriCrop> selectAndOrder(@NotNull Stream<IAgriCrop> candidates, @NotNull Random random);
	...
	interface ICloneLogic {
		 ...
		 */
		@NotNull
		IAgriGenome clone(@NotNull IAgriCrop crop, @NotNull IAgriGenome parent, @NotNull Random random);
	...
	interface ICombineLogic {
		 ...
		 */
		@NotNull
		IAgriGenome combine(@NotNull IAgriCrop crop, @NotNull Tuple<IAgriGenome, IAgriGenome> parents, @NotNull Random random);
