...
import com.agricraft.agricraft.api.genetics.IAllele;
...
public interface IAgriPlant extends IAgriRegisterable<IAgriPlant>, IAgriGrowable.WithSeed, IAllele<IAgriPlant> {
	 ...
	 * @return Optional containing the corresponding fluid state, or empty.
	 */
	 ...
	 *                 listed.
	 */
	void getAllPossibleProducts(@NotNull Consumer<ItemStack> products);
	 ...
	 */
	void getHarvestProducts(@NotNull Consumer<ItemStack> products, @NotNull IAgriGrowthStage growthStage, @NotNull IAgriStatsMap stats, @NotNull Random rand);
	 ...
	 */
	void getAllPossibleClipProducts(@NotNull Consumer<ItemStack> products);
	 ...
	 * @param rand        a random for use in rng.
	 */
	void getClipProducts(@NotNull Consumer<ItemStack> products, @NotNull ItemStack clipper, @NotNull IAgriGrowthStage growthStage,
	                     @NotNull IAgriStatsMap stats, @NotNull Random rand);
	 ...
	 * @param rand a random for use in rng.
	 */
	void spawnParticles(@NotNull IAgriCrop crop, Random rand);
	 ...
	 */
	default boolean allowsHarvest(@NotNull IAgriGrowthStage stage, @Nullable LivingEntity entity) {
	 ...
	 * @return true if the plant can be harvested
	 */
	default boolean allowsClipping(@NotNull IAgriGrowthStage stage, @NotNull ItemStack clipper, @Nullable LivingEntity entity) {
		return stage.isMature();
	}
	 ...
	 */
	default int getBrightness(@NotNull IAgriCrop crop) {
		return 0;
	}
	 ...
	 */
	default int getRedstonePower(@NotNull IAgriCrop crop) {
		return 0;
	}
	 ...
	 */
	default void onPlanted(@NotNull IAgriCrop crop, @Nullable LivingEntity entity) {
	}
	 ...
	 */
	default void onSpawned(@NotNull IAgriCrop crop) {
	}
	 ...
	 */
	default void onGrowth(@NotNull IAgriCrop crop) {
	}
	 ...
	 * @param crop the crop on which this plant was planted
	 */
	default void onRemoved(@NotNull IAgriCrop crop) {
	}
	 ...
	 */
	default void onHarvest(@NotNull IAgriCrop crop, @Nullable LivingEntity entity) {
	}
	 ...
	 */
	default void onClipped(@NotNull IAgriCrop crop, @NotNull ItemStack clipper, @Nullable LivingEntity entity) {
	}
	 ...
	 */
	default void onBroken(@NotNull IAgriCrop crop, @Nullable LivingEntity entity) {
	}
	 ...
	 */
	default void onEntityCollision(@NotNull IAgriCrop crop, Entity entity) {
	}
	 ...
	 */
	default Optional<InteractionResult> onRightClickPre(@NotNull IAgriCrop crop, @NotNull ItemStack stack, @Nullable Entity entity) {
	 ...
	 */
	default Optional<InteractionResult> onRightClickPost(@NotNull IAgriCrop crop, @NotNull ItemStack stack, @Nullable Entity entity) {
		return Optional.empty();
	}
