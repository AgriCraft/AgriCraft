...
public interface IAgriWeed extends IAgriRegisterable<IAgriWeed>, IAgriGrowable {
	 ...
	 */
	default void onGrowthTick(@NotNull IAgriCrop crop) {
	}
	 ...
	 */
	void onRake(@NotNull IAgriGrowthStage stage, @NotNull Consumer<ItemStack> consumer, @NotNull RandomSource rand, @Nullable LivingEntity entity);
