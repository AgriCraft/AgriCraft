...
public class ModCreativeTabs {
	...
	public static final ResourcefulRegistry<CreativeModeTab> CREATIVE_MODE_TAB = ResourcefulRegistries.create(BuiltInRegistries.CREATIVE_MODE_TAB, AgriApi.MOD_ID);
