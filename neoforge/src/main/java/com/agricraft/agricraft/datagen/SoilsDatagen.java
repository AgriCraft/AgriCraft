...
public class SoilsDatagen {
	...
	public static void registerSoils(BootstapContext<AgriSoil> context) {
		mc(context, "farmland", AgriSoil.builder()
				.defaultMods()
				...
				.growthModifier(1.0)
				.build());
		mc(context, "sand", AgriSoil.builder()
				.defaultMods()
				...
				.growthModifier(0.8)
				.build());
		mc(context, "clay", AgriSoil.builder()
				.defaultMods()
				...
				.growthModifier(1.0)
				.build());
		mc(context, "podzol", AgriSoil.builder()
				.defaultMods()
				...
				.growthModifier(1.1)
				.build());
		mc(context, "mycelium", AgriSoil.builder()
				.defaultMods()
				...
				.growthModifier(0.8)
				.build());
		mc(context, "soul_sand", AgriSoil.builder()
				.defaultMods()
				...
				.growthModifier(0.8)
				.build());
		mc(context, "soul_soil", AgriSoil.builder()
				.defaultMods()
				...
				.growthModifier(1.0)
				.build());
		mc(context, "crimson_nylium", AgriSoil.builder()
				.defaultMods()
				...
				.growthModifier(0.75)
				.build());
		mc(context, "warped_nylium", AgriSoil.builder()
				.defaultMods()
